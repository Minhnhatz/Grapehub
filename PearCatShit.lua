...
if _G.Switch_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		ToggleImgUi.Image = "rbxassetid://104186505785775"
		...
		Uitoggle.Text = "Pear Cat Hub"
		Uitoggle.TextColor3 = Color3.fromRGB(255, 0, 255)
		...
		Yedhee.TextColor3 = Color3.fromRGB(255, 0, 0) 
		...
		Notify({
			...
			Title = "Pear Cat Hub Kaitun | "..tostring(game.Players.LocalPlayer.Name),
			Duration = 5
		})
		Notify({
